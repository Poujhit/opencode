...
export default function Page() {
  ...
  const reverting = createMemo(() => revertMutation.isPending || restoreMutation.isPending || ui.reverting)
  const restoring = createMemo(() => {
    if (restoreMutation.isPending) return restoreMutation.variables
    return ui.restoring
  })
