export const dict = {
  ...
  "git.titlebar.actions": "Git",
  "git.titlebar.unavailable": "No Git",
  "git.branch.unknown": "Unknown branch",
  "git.repo.label": "Repo",
  "git.repo.path": "Path",
  "git.repo.unknown": "Unknown repository",
  "git.repo.warning": "You are viewing {{current}}, but this commit will be created in {{root}}.",
  "git.summary.clean": "No changes",
  "git.summary.unavailable": "Git unavailable",
  "git.summary.staged": "Staged",
  "git.summary.unstaged": "Unstaged",
  "git.summary.selected": "Selected",
  "git.action.commit": "Commit changes",
  "git.action.commitPush": "Commit and push",
  "git.action.push": "Push branch",
  "git.commit.title": "Commit changes",
  "git.commit.include": "Include unstaged changes",
  "git.commit.include.help": "Stage all current workspace changes before committing.",
  "git.commit.model.label": "Model",
  "git.commit.model.default": "Server default",
  "git.commit.message.label": "Commit message",
  "git.commit.message.placeholder": "Write a commit message or generate one from the current diff",
  "git.commit.message.required": "A commit message is required.",
  "git.commit.generate": "Auto-generate message",
  "git.commit.generate.loading": "Generating...",
  "git.commit.submitting": "Submitting...",
  "git.toast.commit.title": "Commit created",
  "git.toast.commitPush.title": "Commit pushed",
  "git.toast.push.title": "Branch pushed",
